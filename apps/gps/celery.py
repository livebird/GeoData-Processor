...
# Redis as broker and Django database as result backend (SRS §4)

# Priority queues configuration (FR-JOB-003)

app.conf.update(

    broker_url='amqp://guest:guest@localhost:5672//',  # Use RabbitMQ as broker (matches Django settings)

    result_backend='rpc://',  # RabbitMQ result backend
